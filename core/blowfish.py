class Blowfish:
    ...
    def __init__(self, key):
        ...
        for i in range(0, len(self.p_boxes), 2):
            l, r = self.cipher(l, r, self.CONST_ENCRYPT)
            self.p_boxes[i] = l
            self.p_boxes[i + 1] = r
    ...
    def cipher(self, xl, xr, direction):
        ...
        if direction == self.CONST_ENCRYPT:
            for i in range(16):
    ...
    def encrypt(self, data):
        ...
        cl, cr = self.cipher(xl, xr, self.CONST_ENCRYPT)
        chars = ''.join([
    ...
    def decrypt(self, data):
        ...
        xl, xr = self.cipher(cl, cr, self.CONST_DECRYPT)
        chars = bytes([
...
if __name__ == '__main__':
    print("=" * 30)
    print("Testing Blowfish Encryption")
    print("=" * 30)
    ...
    decrypted = blowfish_engine.decrypt(encrypted_data).decode("utf-8")
